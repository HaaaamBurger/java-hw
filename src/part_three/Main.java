...
public class Main {
    public static void main(String[] args) {
        Car car1 = new Car("Audi", 300f, 270_000f ,new Owner("Alex", (short) 20, (short) 2, true), (short) 2020);
        Car car2 = new Car("Tesla", 250f, 150_000f,new Owner("John", (short) 45, (short) 20, true), (short) 2022);
        Car car3 = new Car("Honda", 125f, 0f,new Owner("Sarah", (short) 19, (short) 1, true), (short) 2003);
        Car car4 = new Car("Citroen", 190f, 0f,new Owner("Tom", (short) 24, (short) 3, true), (short) 2009);
        Car car5 = new Car("BMW", 450f, 0f,new Owner("Jane", (short) 56, (short) 30, true), (short) 2015);
        Car car6 = new Car("Mazda", 220f, 0f,new Owner("Charles", (short) 26, (short) 5, true), (short) 2013);
        Car car7 = new Car("Mercedes", 430f, 0f,new Owner("Winston", (short) 33, (short) 6, true), (short) 2024);
